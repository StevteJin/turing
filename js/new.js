var footer_name = ['about us', 'Twitter', 'RESOURCES', 'Contract ', 'blog', 'GitHub', 'team', 'telegram', 'Whitepaper', 'partners', 'reddit', 'faQ', 'interest', 'youtube', '  ', 'careers'];
var data = {
...
var img_icon = [{
    ...
    class: 'bird',
    src: './images/footer_bird.png'
}, {
    class: 'camera',
    src: './images/footer_camera.png'
}, {
    class: 'player',
    src: './images/footer_player.png'
}, {
    class: 'm',
    src: './images/footer_m.png'
}];
var data1 = {
    iconData: img_icon
};
